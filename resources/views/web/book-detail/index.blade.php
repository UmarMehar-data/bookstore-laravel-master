                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="mb-2">
                        <div class="d-flex justify-content-center mt-3">
                            ...
                            <button class="btn btn-google"><i class="fab fa-google-plus-g mr-3"></i>Google+</button>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 col-12">
                        <div class="d-flex justify-content-end mt-3">
                                ...
                                <button class="btn btn-stock mr-2"><i class="fas fa-shield-alt mr-3"></i>In Stocks</button>
                ...
                <div class="row top-border pt-4">
                    ...
                    <div class="col-sm-12 col-md-6 col-12">
                        <div class="d-flex justify-content-end">
                            <button class="btn btn-purple mr-2"><i class="fas fa-cart-plus mr-3 "></i>Add to Cart</button>
